...
import (
	...
	"github.com/trillyai/backend-microservices/services/trip/handler"
	"github.com/trillyai/backend-microservices/services/trip/repository"
	"github.com/trillyai/backend-microservices/services/trip/service"

	// docs are generated by Swag CLI, you have to import them.
	_ "github.com/trillyai/backend-microservices/services/trip/docs"
)
...
func init() {
	...
	if err := postgres.MigrateSchema(tables.Trip{}, tables.TripInterest{}); err != nil {
		os.Exit(1)
	}
}
...
func GetServerApp() *fiber.App {
	app := fiber.New()
	logger := logger.NewLogger("trip-server")
	handler := getHandler()
	...
	authMw.Post(trip, handler.CreateTrip)
